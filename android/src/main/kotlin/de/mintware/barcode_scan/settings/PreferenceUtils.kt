...
package de.mintware.barcode_scan.settings
...
import de.mintware.barcode_scan.R
import de.mintware.barcode_scan.camera.CameraSizePair
...
object PreferenceUtils {
    ...
    fun isAutoSearchEnabled(context: Context): Boolean = true;

    fun isMultipleObjectsMode(context: Context): Boolean = false;
